...
public class EmployeesDAO {
	...
	/*
	 * Connection getConnection(){ Connection conn = null; Context initContext;
	 * 
	 * try{ initContext = new InitialContext(); Context envContent = (Context)
	 * initContext.lookup("java:/comp/env"); DataSource ds = (DataSource)
	 * envContent.lookup("jdbc/myoracle"); conn = ds.getConnection();
	 * 
